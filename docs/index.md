...
- [ ] Cartes de templates sur mesure (versions sombre et claire, sans effet au survol): codées le 2026-09-25, à déployer et vérifier, voir [Template cards](backstage/personnalisation/custom/template-cards.md)
