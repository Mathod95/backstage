...
- [ ] Décider: branding (titre `Mathod`, logos, page d'accueil), fait sur l'ancienne instance. Carte de tous les réglages: [settings](backstage/settings.md), [branding](backstage/personnalisation/branding.md). Page de connexion: maquette 2 retenue, voir [login screen](backstage/personnalisation/custom/login-screen.md)
...
- [ ] Cartes de templates sur mesure (versions sombre et claire, sans effet au survol): codées, puis désactivées (carte standard de retour, module conservé), voir [Template cards](backstage/personnalisation/custom/template-cards.md)
- [ ] Thème de couleurs Émeraude sobre (clair et sombre, MUI et BUI): codé, à déployer et vérifier, voir [Emerald theme](backstage/personnalisation/emerald-theme.md)
...
- [ ] Remplacer TechDocs par un site Zensical publié sur GitHub Pages et affiché dans une iframe (page Docs, onglet Docs des fiches, bouton Docs des cartes): en attente tant que la recherche intégrée de Backstage n'a pas de solution
...
- [x] Premier template `github-create-repo`: crée un repo GitHub vide chez un client, jeton saisi à chaque utilisation (2026-09-25), doc dans [Create repository](templates/github/create-repository.md)
